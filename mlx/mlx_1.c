...
/*   Updated: 2024/08/02 22:07:37 by rkobelie         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	game->textures.coin = mlx_xpm_file_to_image(game->mlx, "textures/coin.xpm",
			&(game->lenght), &(game->height));
...
void	init_game(t_init_game game)
{
	...
	game.window = mlx_new_window(game.mlx, game.lenght * 50, game.height * 50,
			"so_long");
